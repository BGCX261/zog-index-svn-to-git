...
<style type="text/css">
	...
	#workPic{margin-top:10px;text-align:center;}
        ...
        <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1000" height="35" id="FlashID" title="nav">
 		...
 		<div id="main">
        	...
        	<div id="middle">
				...
				<div id="mainM">
					<div id="mainLine"></div>
					<div id="return"><a href="/c?t=ps">返回列表</a></div>
					<div id="newsTit">${p.title}</div>
					<div id="workPic">
					<img src="/i?id=${p.img}" title="${p.context}" alt="${p.context}"></img>
					</div>
				</div>
				<div id="mainBottom">
					<div id="mbStart"></div>
